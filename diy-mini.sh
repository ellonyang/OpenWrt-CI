...
git clone --depth=1 master https://github.com/vernesong/OpenClash luci-app-openclash
...
#git clone --depth=1 https://github.com/haiibo/packages luci-theme-opentomcat
